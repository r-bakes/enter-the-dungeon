    ...
    return (
        <div className="flex flex-col w-full h-full">
            {item.attackBonus > 0 ? (
                ...
                <Label className="text-xs font-light text-muted-foreground">attack</Label>
            </div>) : <></>
            }
            {item.defenseBonus > 0 ? (
                <div className="flex justify-between">
                    <Label className="text-xs">{item.defenseBonus}</Label>
                    <Label className="text-xs font-light text-muted-foreground">defense</Label>
                </div>
            ) : <></>
            }
            {item.healthBonus > 0 ? (
                <div className="flex justify-between">
                    ...
                    <Label className="text-xs font-light text-muted-foreground">health</Label>
                </div>) : <></>
            }
        </div>
    )
