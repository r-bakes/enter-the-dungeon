...
export default function SkillMenu({ skill }: Readonly<{ skill: Skill }>) {
  ...
  const { setWorkingTask, workingTask, taskWorkingLocked, taskProgress } = useWorkingEngineContext();
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (controlBarElement) {
        ...
        const controlBarTop = controlBarRect.top - containerRect.top + scrollTop;
  ...
  return (
    <div className="flex h-full w-full flex-col">
      ...
      {isSticky && (
        <div className="lg:hidden fixed top-0 left-20 right-4 z-40">
          <div className="flex flex-col gap-2 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b rounded-b-lg p-3 shadow-lg">
            {/* Progress bar */}
            ...
            <div className="flex gap-2">
              ...
              <Button
                className="flex-1 h-10"
                variant={task && task == workingTask ? "destructive" : "secondary"}
              ...
              <Sheet>
                ...
                <SheetContent side="right" className="w-[400px] sm:w-[540px] pb-24">
                  <SheetHeader>
      ...
      <div 
        ...
        className="flex h-full w-full flex-col gap-4 md:gap-6 px-4 md:px-8 overflow-y-auto"
      >
        <SkillHeader
          skill={skill}
        ...
        <div className="lg:hidden">
          <div 
            ref={controlBarRef}
            className="flex flex-col gap-2 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border rounded-lg p-3 shadow-lg"
          >
            {/* Progress bar */}
            <div className="w-full">
              <Progress
        ...
        <div className="flex min-h-0 w-full grow gap-4 md:gap-6 flex-col lg:flex-row">
          ...
          <div className="hidden lg:flex min-h-0 w-full grow gap-6">
            <TaskInfo task={task} />
            <TasksMenu
              skill={skill}
              tasks={Object.values(skill.tasks)}
